...
public final class QueryUtils  {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            JSONArray resultsList = response.getJSONArray("results");
            ...
            for (int i = 0; i < resultsList.length(); i++) {
                ...
                String time = parts[1].substring(0,parts[0].length()-1);
                ...
                News earthquake = new News(title,section,url,parts[0],time,author);
